...
PlainStatementsList.propTypes = {
    statementCategories: PropTypes.array
}

export default function PlainStatementsList(props) {
    ...
    return (
        props.statementCategories.map((statementCategoryRow) => {
            return (
                <div>
                    <Typography variant="h6">{statementCategoryRow.categoryName}</Typography>
